      ...
      <main className="flex-grow flex flex-col items-center p-4 md:p-8 select-none">
        ...
        >
          ...
          <div className="w-full max-w-[850px] flex flex-col items-center px-1">
            ...
            {/* 🎛️ Interactive Stream Server Switcher (Unified Horizontal Scrollview for all screens) */}
            <div className="w-full mt-6 max-w-[850px] mx-auto px-1 select-none">
              <div className="flex flex-row overflow-x-auto gap-4 w-full pb-4 no-scrollbar justify-start md:justify-center scroll-smooth snap-x snap-mandatory">
                {CHANNELS.map((ch, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex-shrink-0 w-[240px] text-left transition-all duration-300 cursor-pointer rounded-xl border p-4 flex flex-row items-center gap-3 relative overflow-hidden group/btn snap-center ${
                        isActive 
