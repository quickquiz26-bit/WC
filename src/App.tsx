          ...
          <div className="w-full max-w-[850px] flex flex-col items-center px-1">
            ...
            <div className="tv-viewport w-full max-w-[550px] mx-auto relative mb-6">
              ...
              <div className={`tv-frame ${theme.cardBg} border ${theme.borderColor} ${theme.glowColor} rounded-2xl relative overflow-hidden transition-all duration-300 w-full`}>
                ...
                {/* Embedded Cropped Custom Live Frame (Exactly respecting original cropped dimension mappings with decreased height) */}
                <div className="crop-viewport relative w-full aspect-ratio-16-9 h-[340px]">
            ...
            <div className="w-full mt-6 max-w-[850px] mx-auto px-1">
                ...
                {CHANNELS.map((ch, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex-shrink-0 w-[240px] text-left transition-all duration-300 cursor-pointer rounded-xl border p-4 flex flex-row items-center gap-3 ${
                        isActive 
                ...
                {CHANNELS.map((ch, idx) => {
                  ...
                  return (
                    <button
                      key={ch.id}
                      onClick={() => switchSource(ch.url)}
                      className={`w-full text-left transition-all duration-305 cursor-pointer rounded-xl border flex flex-row items-center p-4 gap-4 ${
                        isActive 
                          ? `bg-[#ff0000]/5 border-[#ff0000]/70 shadow-[0_0_15px_rgba(255,0,0,0.05)]` 
                          : 'bg-[#111111] border-[#222222] hover:border-zinc-700'
                      }`}
